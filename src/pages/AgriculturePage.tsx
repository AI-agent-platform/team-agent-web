...
import { Home, Sprout, Eye, Droplets, TrendingUp, Scissors, Thermometer, Smartphone } from "lucide-react";
...
const HeroSection = styled.section`
  ...
  &::before {
    ...
    width: 50%;
    height: 100%;
    background-image: url(${require('../Assets/areas/aggriculture.jpg')});
